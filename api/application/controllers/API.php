	...
	function registration_post()
	{
		...
		if($user_id)
		{
			if($post_data->addUser == '1'){
			    ...
			    You have been invited to join the ".$company_name." HaveItAll Hiring team. Please <a href=".$post_data->regular_url.$user_id.">click here</a> to create your account password. <br><br>Thank you,<br>The HaveItAll Admin Team.<br>www.haveitall.ca<br><br><br>If you have received this email in error, please <a href='mailto:report@haveitall.ca'>click here</a> to report of unsubscribe.";
...
============================================================================= */
	...
	function get_time_difference_php($created_time)
 {
     ...
     // (UTC-08:00) Pacific Time (US/Canada);
        ...
        {
  //echo"i am in year";
  return date("jS F, Y", strtotime($created_time)); 
